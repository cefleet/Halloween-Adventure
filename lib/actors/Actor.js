...
Game.Actor.prototype = {
	...
	calculate_boxes : function(){
		...
		var boxes = {
			left : {x:this.sprite.x-6, y:this.sprite.y, w:this.sprite.w/2, h:this.sprite.h},
			right: {x:this.sprite.x+(this.sprite.w/2)+6, y:this.sprite.y, w:this.sprite.w/2, h:this.sprite.h},
			top: {x:this.sprite.x, y:this.sprite.y-6, w:this.sprite.w, h:this.sprite.h/2},
			bottom: {x:this.sprite.x, y:this.sprite.y+(this.sprite.h/2)+6,w:this.sprite.w,h:this.sprite.h/2},
			fullBox: {x:this.sprite.x-6,y:this.sprite.y-6,w:this.sprite.w+12,h:this.sprite.h+12}
		}
		this.boxes = boxes;
	},
	...
	render: function(){
		...
		this.engine.ctx.drawImage(this.sprite.image.image,0,0,40,40,this.sprite.x, this.sprite.y, this.sprite.w, this.sprite.h);
	},
